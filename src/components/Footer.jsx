...
export default function Footer() {
  return (
    <footer
      ...
      style={{ background: 'var(--color-deepest)', borderColor: 'rgba(255, 215, 0, 0.1)' }}
    >
      <div className="max-w-container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-12">
          <div>
            <div className="text-xl font-black mb-1" style={{ color: 'var(--color-yellow)' }}>
              ⚡ VOLT ELECTRICS
            </div>
            <div className="text-xs font-bold uppercase tracking-widest mb-4" style={{ color: 'var(--color-muted)' }}>
              NSW Licence #EL78234C · ABN 51 234 567 890
            </div>
            <p className="text-sm leading-relaxed" style={{ color: 'var(--color-muted)' }}>
              Expert electrical solutions for Parramatta and Greater Western Sydney. Quality
              workmanship, safety first, every time.
            </p>
          </div>
        ...
        <div className="pt-8 border-t flex flex-col md:flex-row justify-between items-center gap-4 footer-divider">
          <p className="text-xs" style={{ color: 'var(--color-muted)' }}>
            © {year} Volt Electrics. All Rights Reserved. Licensed Electrical Contractor NSW.
            Licence #EL78234C
          </p>
          <p className="text-xs" style={{ color: 'var(--color-muted)' }}>
            Website by <span style={{ color: 'var(--color-yellow)' }}>Your Web Agency</span>
          </p>
        </div>
      </div>
    </footer>
